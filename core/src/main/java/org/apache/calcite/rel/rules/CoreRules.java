...
public class CoreRules {
  ...
  /** Rule that merges a {@link Union} on top of {@link Project}s
   * on top of {@link Filter}s, resulting in a {@link Project}
   * on top of a {@link Filter} with an OR condition. */
  public static final SetOpFilterMergeRule SET_OP_PROJECT_FILTER_MERGE_RULE =
      SetOpFilterMergeRule.Config.DEFAULT.toRule();
}
