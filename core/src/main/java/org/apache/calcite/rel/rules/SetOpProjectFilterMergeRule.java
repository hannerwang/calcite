...
public class SetOpProjectFilterMergeRule
    extends AbstractSetOpFilterMergeRule<SetOpProjectFilterMergeRule.Config>
  ...
  @Override public void onMatch(RelOptRuleCall call) {
    ...
    if (!union.all) {
      applyUnion(call, relBuilder, rexBuilder, simplify, leftProject,
          rightProject, leftFilter, rightFilter);
    } else {
